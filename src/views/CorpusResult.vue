        ...
        <Section title="result">
            ...
            <div v-else>
                ...
                <ActionButton
                    ...
                    >
                    <div class="flex">
                        {{ $t("download") }} {{ $t("corpus") }} <img src="@/assets/zip.svg" class="h-5 opacity-75 pl-2" />
                    </div>
                </ActionButton>
            </div>
        </Section>
...
const { loadExports, exports, downloadResult, downloadFileXML, downloadFileTxt } = useExports(); 
