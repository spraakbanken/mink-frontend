...
- Mark config with a special comment `# Generated by Mink` when saved with the standard options form, and warn before overwriting custom config from that form
